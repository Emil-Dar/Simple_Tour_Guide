...
public class longbeach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_longbeach);

        locationbtn = findViewById(R.id.balloc);

        String location = getString(R.string.longbeach_location_url);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(longbeach.this, places.class);
